...
> 当前 Windows 便携版：[`v0.1.0-alpha.3`](https://github.com/jacky0jia/video_translator/releases/tag/v0.1.0-alpha.3)。客机安装、设置重启保留已通过验收，当前源码 CI 通过。仍处于 Alpha 阶段，质量和速度取决于模型与硬件。
...
从 [Releases](https://github.com/jacky0jia/video_translator/releases/tag/v0.1.0-alpha.3) 下载完整 Windows x64 ZIP 并解压，双击 `start-portable.bat` 启动、`install-upstream.bat` 打开依赖安装菜单。主体自带 Python、已构建前端、ASR small 和八个参考音色，无需另装 Python/Node.js。
