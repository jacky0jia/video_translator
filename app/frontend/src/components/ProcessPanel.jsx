...
export default function ProcessPanel(props) {
  ...
  return <section className="app-panel overflow-hidden">
    ...
    <div className="space-y-4 p-4">
      ...
      <button type="button" className="app-primary-button" onClick={() => run()} disabled={running || !task.transcription_path || (route === 'dubbing' && !voice)}>{running ? t('processing') : route === 'dubbing' ? t('createDubbedVideo') : burn ? t('createHardSubtitleVideo') : t('createSubtitleFile')}</button>
